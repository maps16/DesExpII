...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.20\linewidth]{aleatoria.png}
...
Para la configuración aleatoria regular, llegamos a lo siguiente:

\begin{figure}[H]
	\centering
	\includegraphics[width=1.20\linewidth]{regular.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.20\linewidth]{traslapes.png}
