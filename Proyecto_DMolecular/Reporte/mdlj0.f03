...
PROGRAM DMLJ
  ...
  !CALCULOS PREVIOS
  A=1.0/3.0    
  BOX=(N/DENS)**A  !Longitud DE CELDA
  ...
  VLRC = ( 8.0 /9.0 ) * PI * DENS * REAL ( N )* ( SR9 - 3.0 * SR3) !CORRECION LARGO ALCANCE ENERGIA
  ...
  DO ISTEP = 1, NSTEP
     ...
     ! SISTEMA CONSISTENTE CON LA TEMPERATURA DEL BANO TERMICO PARA
     ! UNA DESCRIPCION NVT.
